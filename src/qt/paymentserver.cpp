...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click bitinum: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start bitinum: click-to-pay handler");
    else
...
{
    // clicking on bitinum: URLs creates FileOpen events on the Mac:
